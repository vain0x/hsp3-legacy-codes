...
#ifndef IG_MODULECLASS_HSP_DEFINITION_LISTER_AS
#define IG_MODULECLASS_HSP_DEFINITION_LISTER_AS
...
#module MCDeflister mScript, mCount, mFileName, mFilePath, mIdent, mLn, mType, mScope, mInclude, mCntInclude
...
// コンストラクタ
//------------------------------------------------
#define global hspDeflister_new(%1,%2) newmod %1, MCDeflist@, %2
#modinit str path
	// メンバ変数を初期化
	sdim mIdent,, 5
	dim  mLn,     5
...
#modfunc hspDeflister_list  local tktypelist, local tkstrlist, local befTkType, local idx, local cntToken, local sIdent, local areaScope, local scope, local nowline, local bGlobal, local bLocal, local deftype, local uniqueCount, local fSplit
	// 字句解析
	fSplit  = HspLexer_Flag_NoBlank
	fSplit |= HspLexer_Flag_NoReserved
	
	hspLexer_new lexer
	hspLexer_set lexer, fSplit
	hspLexer_lex lexer, tktypelist, tkstrlist, mScript
