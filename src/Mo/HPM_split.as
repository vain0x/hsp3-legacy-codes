...
//------------------------------------------------
#deffunc hpm_split array tktypelist, array tkstrlist, str prm_script, int fSplit,  local script, local lenScript, local cntToken, local tkstr, local tktype, local bPreprocLine, local index, local befTkType, local bNoBlank, local bNoComment, local bNoScope, local bNoReserved
	sdim tkstr
	dim  tktype
