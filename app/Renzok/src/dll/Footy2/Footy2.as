...
#ifdef	__hsp30__
#ifndef	__FOOTY2_DLL_H__
#define	__FOOTY2_DLL_H__
#uselib	"Footy2.dll"
...
// ************
// バージョン取得関数（ヘルプの3章）
#cfunc  global GetFooty2Ver "GetFooty2Ver"
#cfunc  global GetFooty2BetaVer "GetFooty2BetaVer"
...
#cfunc  global Footy2GetWnd "Footy2GetWnd" int,int
#cfunc  global Footy2GetWndVSplit "Footy2GetWndVSplit" int
#cfunc  global Footy2GetWndHSplit "Footy2GetWndHSplit" int
#cfunc  global Footy2GetActiveView "Footy2GetActiveView" int
...
#cfunc  global _Footy2IsEdited "Footy2IsEdited" int
...
#cfunc  global _Footy2IsShiftLocked "Footy2IsShiftLocked" int
...
#define global Footy2DeleteSel(%1) Footy2SetSelText (%1), ""
...
#cfunc  global  Footy2GetCharSet "Footy2GetCharSet" int
#cfunc  global  Footy2GetLineCode "Footy2GetLineCode" int
...
#cfunc  global  Footy2GetTextLengthA "Footy2GetTextLengthA" int,int
#cfunc  global  Footy2GetTextLengthW "Footy2GetTextLengthW" int,int
#cfunc  global  Footy2GetSelLengthA "Footy2GetSelLengthA" int,int
#cfunc  global  Footy2GetSelLengthW "Footy2GetSelLengthW" int,int
...
#cfunc  global  Footy2GetLineW "Footy2GetLineW" int,int
#cfunc  global  Footy2GetLineA "Footy2GetLineA" int,int,sptr,int
#cfunc  global  Footy2GetLineLengthW "Footy2GetLineLengthW" int,int
#cfunc  global  Footy2GetLineLengthA "Footy2GetLineLengthA" int,int
#cfunc  global  Footy2GetLines "Footy2GetLines" int
...
#cfunc  global  Footy2GetVisibleColumns "Footy2GetVisibleColumns" int,int
#cfunc  global  Footy2GetVisibleLines "Footy2GetVisibleLines" int,int
...
#define	global Footy2GetTextLength	Footy2GetTextLengthW
#define	global Footy2GetLine		Footy2GetLineW
#define	global Footy2SetLine		Footy2SetLineW
#define	global Footy2GetLineLength	Footy2GetLineLengthW
...
#define	global Footy2GetTextLength	Footy2GetTextLengthA
#define	global Footy2GetLine		Footy2GetLineA
#define	global Footy2SetLine		Footy2SetLineA
#define	global Footy2GetLineLength	Footy2GetLineLengthA
...
// nLimeMode 引数：保存するときの改行コード（LineMode）
...
// 日本語
#enum global CSM_SHIFT_JIS_2004						// ShiftJIS のJIS X 0213:2004拡張( WindowsVista 標準 )
#enum global CSM_EUC_JIS_2004						// EUC-JP   のJIS X 0213:2004拡張
...
//#enum global CSM_ISO8859-12 ( 1997年に破棄されました )
...
#enum global CSM_ERROR								// エラー ( 内部処理用 )
...
#enum global FFM_NUM_FONTS							// フォントの数 ( 内部処理用 )
...
#define global EMP_IND_BRACKETS			0x0000000F	// すべての括弧を許可する
#define global EMP_IND_ANSI_SIGNS		0x000000D0	// ANSI 記号を許可する(QUOTATION OPERATORS OTHER_ASCII_SIGNS)
#define global EMP_IND_ALPHABETS		0x00000600	// 大・小のアルファベットを許可する
...
#define global FOOTY2ERR_ARGUMENT		(-1)		// 引数がおかしい
...
#define global FOOTY2ERR_ENCODER		(-10)		// 文字コードのエンコーダが見つからない(ファイルのエンコード形式が不正です、バイナリとか)

#endif	/*__FOOTY2_DLL_H__*/
#endif	/*__hsp30__*/
